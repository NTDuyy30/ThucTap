	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow mx-1"><a
			...
			<div
				...
				</a> <a class="dropdown-item text-center small text-gray-500" href="#">Hiển thị tất cả thông báo</a>
			</div></li>
		...
		<li class="nav-item dropdown no-arrow mx-1"><a
			...
			<div
				...
				</a> <a class="dropdown-item text-center small text-gray-500" href="#">Hiển thị tất cả tin nhắn</a>
			</div></li>
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			aria-expanded="false"> <span
				class="mr-2 d-none d-lg-inline text-gray-600 small">Nhóm 5</span> <img class="img-profile rounded-circle"
			...
			<div
				...
				<a class="dropdown-item" href="#"> <i
					...
					class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i> Đổi mật khẩu
				</a> <a class="dropdown-item" href="#"> <i
					class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i> Nhật ký hoạt động
				</a>
